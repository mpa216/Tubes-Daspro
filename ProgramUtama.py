from FungsiUtama import length,lengthcandi,mappend,my_split,del_element,my_max,my_min,my_sort,append_lain
import random
import sys
import argparse
import csv
        ...
        if x==1:
            ...
            for i in range (2,102):
                if arrUser[i][0]==username_jin:
                    ...
                    tambah = True
            if tambah:
                arrUser = append_lain(arrUser,[username_jin,password_jin,'jin_pengumpul'])
        elif x==2:
            ...
            for i in range (2,102):
                if arrUser[i][0]==username_jin:
                    ...
                    tambah = True
            if tambah:
                arrUser = append_lain(arrUser,[username_jin,password_jin,'jin_pembangun'])
    else :
