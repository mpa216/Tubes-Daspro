...
def ubahtipe():
    ...
    if ada:
        if arrUser[i][2]=="jin_pembangun":
            tipe,kebalikan = "Pembangun","Pengumpul"
        else:
            tipe,kebalikan = "Pengumpul","Pembangun"
        masukan = str(input(f'Jin ini bertipe {tipe}. Yakin ingin mengubah ke tipe {kebalikan} (Y/N)? '))
